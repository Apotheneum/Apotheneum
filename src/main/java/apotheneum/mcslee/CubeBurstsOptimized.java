...
@LXComponent.Name("Cube Bursts-Optimized")
@LXComponent.Description("MIDI reactive emanations on the cube faces (performance-optimized)")
public class CubeBurstsOptimized extends BurstsOptimized implements ApotheneumPattern.Midi, UIDeviceControls<CubeBurstsOptimized> {
  ...
  public CubeBurstsOptimized(LX lx) {
    super(lx);
  ...
  @Override
  public void buildDeviceControls(UI ui, UIDevice uiDevice, CubeBurstsOptimized cubeBursts) {
