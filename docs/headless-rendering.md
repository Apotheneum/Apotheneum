...
therefore falls near the image center and the bottom row reaches the image edge. Every
output pixel samples its nearest real cylinder-interior LED with no smoothing.
